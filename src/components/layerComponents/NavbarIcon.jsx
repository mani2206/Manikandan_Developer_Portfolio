    ...
    <>
     ...
     <ul className=" navbaricon text-center d-flex justify-content-between p-0 m-0">
            <li className="active  align-items-center" style={{padding: "3px"}}>
              ...
              <a className="nav-link  text-dark"  style={{fontSize:"10px",padding: "5px"}} href="/">
                Home <span className="sr-only"></span>
              </a>
            </li>
            <li className="align-items-center" style={{padding: "3px"}}>
              ...
              <a className="nav-link  text-dark"  style={{fontSize:"10px",padding: "5px"}} href="#about">
                About
              </a>
            </li>
            <li className=" align-items-center" style={{padding: "3px"}}>
              ...
              <a className="nav-link text-dark"  style={{fontSize:"10px",padding: "5px"}}href="#resume">
                Resume
              </a>
            </li>
            <li className="align-items-center" style={{padding: "3px"}}>
              ...
              <a className="nav-link  text-dark" style={{fontSize:"10px",padding: "5px"}} href="#project">
                Projects
              </a>
            </li>
            <li className="align-items-center "  style={{padding: "3px"}}>
              ...
              <a className="nav-link text-dark"  style={{fontSize:"10px",padding: "5px"}} href="#contact">
                Contact
              </a>
            </li>
          </ul>
