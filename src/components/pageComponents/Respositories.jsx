...
function Respositories() {
  const config = {
    projects: [
      ...
      {
        name: "Quiz",
        description: "Quiz webpage built using HTML Bootstrap5 SCSS Javascript This initiative offers a fundamental blueprint for individuals aspiring to construct a simple Quiz website with a responsive layout and refined styling",
            ...
            <div className="d-flex justify-content-around align-items-center">
              ...
              <button className="btn rounded">
                {project.demoLink ? (
                  ...
                  <span>
                    <Link to="/error" className="res-link">In Progress</Link>
                  </span>
                )}
              </button>
            </div>
